...
function createUser(name: string, age: number, status: boolean): User {
...
function getOrderStatus(status: OrderStatus): string {
    ...
    switch (status) {
        case OrderStatus.Pending:
            result = "Замовлення очікує на обробку";
            break;
        case OrderStatus.Shipped:
            result = "Замовлення було відправлено";
            break;
        case OrderStatus.Delivered:
            result = "Замовлення доставлено";
            break;
        case OrderStatus.Cancelled:
            result = "Замовлення скасовано";
            break;
        default:
            result = "Невідомий статус замовлення";
            break;
    }
