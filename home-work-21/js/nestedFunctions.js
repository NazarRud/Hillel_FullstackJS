...
console.log("-> Розробка Функції Трирівневої Вкладеності в JavaScript з Конкретною Операцією");
console.log('Result:', outerFunction(2)(3)(4)); // Повинно повернути 24 (2*3*4)
