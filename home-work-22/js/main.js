...
function getCounterFactory(start = 0) {
    let count = start;
...
console.log("%cЗавдання - #5 подвоює параметр", theme);
...
console.log("%cЗавдання - #5 потроює параметр", theme);
